...
export const strings = {
  de: {
    ...
    'queue.bulk.retry_errors': 'Alle Fehler retry',
    'queue.bulk.clear_errors': 'Fehler löschen',
    'queue.bulk.clear_completed': 'Fertige löschen',
  ...
  en: {
    ...
    'queue.bulk.retry_errors': 'Retry all errors',
    'queue.bulk.clear_errors': 'Clear errors',
    'queue.bulk.clear_completed': 'Clear completed',
